...
int main() {
    ...
    // REPL Greeting
    std::cout << "\e[1mPYSCRIPT\e[0m 1.0.0  [12th December, 2023]" << std::endl;
    ...
    for(;;){
        ...
        // Help
            ...
            std::cout << "To use this interactive REPL, just type in regular PYSCRIPT commands and hit\n";
            ...
            std::cout << " #quit            Exits the PYSCRIPT REPL.\n\n";
